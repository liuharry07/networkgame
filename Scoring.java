...
public class Scoring {
    ...
    public int[] valuateHand()
    {
       ...
       if(posStraight.size()>=5)
       {
        ...
        {
            straightList[4] = posStraight.get(4);
            straight = true;
            straightTop = posStraight.get(0).getValue();
        }
        else
        ...
        if(a<=1)
        {
            ...
            int b=1;
            if(posStraight.size()>5 && (posStraight.get(0).getValue()-posStraight.get(1).getValue())!=1)
            {
                posStraight.remove(0);
            }
            ...
            if(b==5)
            {
                straightList[4] = posStraight.get(b-1);
                straight = true;
                straightTop = posStraight.get(0).getValue();
            }
        }
